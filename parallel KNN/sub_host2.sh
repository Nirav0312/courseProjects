...
#sort hostnames
sort $PBS_NODEFILE > hostfile2
#run the job on required number of cores

filenamecsv="./hpc/data2/data2_host2.csv"
touch $filenamecsv
...
do
    ...
    do
        ...
        mpirun -machinefile hostfile2 -np $i ./src.x 16 1640000 100 "./data2/" $filename $filenamecsv

    done
done


filenamecsv="./hpc/data1/data1_host2.csv"
touch $filenamecsv
truncate -s 0 $filenamecsv
for (( i = 5; i <= 7; i++ ))
do
    ...
    do
        ...
        # ./x no_of_timestep max_no_of_points max_no_of_clusters data_file_path write_cluster_file_path write_csv_file_path
        mpirun -machinefile hostfile2 -np $i ./src.x 17 65000 100 "./data1/" $filename $filenamecsv
